...
#
# Il permet aussi de traiter les fichiers .mat (voir à la
# fin du fichier)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Cette fonction sert à construire les jeux de données à partir
# des fichiers .mat fournis et les enregistre sous la forme
# de fichiers .csv
#
# Elle s'exécute avec :
